...
public class LowMemoryTextVertexBufferObject extends LowMemoryVertexBufferObject
    implements ITextVertexBufferObject
{
    ...
    public LowMemoryTextVertexBufferObject(VertexBufferObjectManager vertexbufferobjectmanager, int i, DrawType drawtype, boolean flag, VertexBufferObjectAttributes vertexbufferobjectattributes)
    {
    ...
    public void onUpdateColor(Text text)
    {
        ...
        do
        {
            ...
            floatbuffer.put(2 + (i + 0), f);
            floatbuffer.put(2 + (i + 5), f);
            floatbuffer.put(2 + (i + 10), f);
            floatbuffer.put(2 + (i + 15), f);
            floatbuffer.put(2 + (i + 20), f);
            floatbuffer.put(2 + (i + 25), f);
            i += 30;
            k++;
        } while (true);
    }
...
_L2:
        ...
        if (letter != null)
        {
            char c = letter1.mCharacter;
            f2 += letter.getKerning(c);
        }
        if (!letter1.isWhitespace())
        {
            ...
            floatbuffer.put(0 + (j + 0), f4);
            floatbuffer.put(1 + (j + 0), f5);
            floatbuffer.put(3 + (j + 0), f8);
            floatbuffer.put(4 + (j + 0), f9);
            floatbuffer.put(0 + (j + 5), f4);
            floatbuffer.put(1 + (j + 5), f6);
            floatbuffer.put(3 + (j + 5), f8);
            floatbuffer.put(4 + (j + 5), f11);
            floatbuffer.put(0 + (j + 10), f7);
            floatbuffer.put(1 + (j + 10), f6);
            floatbuffer.put(3 + (j + 10), f10);
            floatbuffer.put(4 + (j + 10), f11);
            floatbuffer.put(0 + (j + 15), f7);
            floatbuffer.put(1 + (j + 15), f6);
            floatbuffer.put(3 + (j + 15), f10);
            floatbuffer.put(4 + (j + 15), f11);
            floatbuffer.put(0 + (j + 20), f7);
            floatbuffer.put(1 + (j + 20), f5);
            floatbuffer.put(3 + (j + 20), f10);
            floatbuffer.put(4 + (j + 20), f9);
            floatbuffer.put(0 + (j + 25), f4);
            floatbuffer.put(1 + (j + 25), f5);
            floatbuffer.put(3 + (j + 25), f8);
            floatbuffer.put(4 + (j + 25), f9);
            j += 30;
            i++;
        }
        f2 += letter1.mAdvance;
