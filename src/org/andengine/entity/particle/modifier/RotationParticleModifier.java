...
public class RotationParticleModifier extends BaseSingleValueSpanParticleModifier
{
    ...
    public RotationParticleModifier(float f, float f1, float f2, float f3)
    {
        this(f, f1, f2, f3, ((IEaseFunction) (EaseLinear.getInstance())));
    }

    public RotationParticleModifier(float f, float f1, float f2, float f3, IEaseFunction ieasefunction)
    {
    ...
    {
        particle.getEntity().setRotation(f1);
    }
}
