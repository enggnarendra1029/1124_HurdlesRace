...
public class CircleOutlineParticleEmitter extends BaseCircleParticleEmitter
{
    ...
    public CircleOutlineParticleEmitter(float f, float f1, float f2)
    {
        super(f, f1, f2);
    }

    public CircleOutlineParticleEmitter(float f, float f1, float f2, float f3)
    {
        super(f, f1, f2, f3);
    }
    ...
    public void getPositionOffset(float af[])
    {
        ...
        af[0] = mCenterX + FloatMath.cos(f) * mRadiusX;
        af[1] = mCenterY + FloatMath.sin(f) * mRadiusY;
    }
}
