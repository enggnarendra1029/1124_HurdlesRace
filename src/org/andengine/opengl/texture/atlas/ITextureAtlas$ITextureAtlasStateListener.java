...
public static interface TextureAtlasStateAdapter
    extends ITextureStateListener
{
    public static class DebugTextureAtlasStateListener
        implements ITextureAtlas.ITextureAtlasStateListener
    {
        ...
        public DebugTextureAtlasStateListener()
        {
        }
    }

    public static class TextureAtlasStateAdapter
        implements ITextureAtlas.ITextureAtlasStateListener
    {
        ...
        public TextureAtlasStateAdapter()
        {
        }
    }
