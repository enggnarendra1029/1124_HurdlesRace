...
_L6:
        ...
        public CriteriaShaderSourceEntry(String s)
        {
            this(s, null);
        }

        public transient CriteriaShaderSourceEntry(String s, IGLCriteria aiglcriteria[])
        {
    ...
    public transient CriteriaShaderSource(CriteriaShaderSourceEntry acriteriashadersourceentry[])
    {
        mCriteriaShaderSourceEntries = acriteriashadersourceentry;
    }
    ...
    public String getShaderSource(GLState glstate)
    {
        ...
        do
        {
            if (i >= mCriteriaShaderSourceEntries.length)
            {
                throw new ShaderProgramException((new StringBuilder("No ")).append(org/andengine/opengl/shader/source/CriteriaShaderSource$CriteriaShaderSourceEntry.getSimpleName()).append(" met!").toString());
            }
            CriteriaShaderSourceEntry criteriashadersourceentry = mCriteriaShaderSourceEntries[i];
