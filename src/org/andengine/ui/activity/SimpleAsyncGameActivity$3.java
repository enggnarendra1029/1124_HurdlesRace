    ...
    implements Runnable
{
    ...
    private final org.andengine.ui.ceneCallback val$pOnPopulateSceneCallback;
    private final Scene val$pScene;

    public void run()
    {
        ActivityUtils.doProgressAsync(SimpleAsyncGameActivity.this, "Populating Scene...", 0x108004d, new ProgressCallable() {
    ...
    ack()
    {
        ...
        val$pScene = scene;
        val$pOnPopulateSceneCallback = org.andengine.ui.ceneCallback.this;
        super();
    }
}
