...
class ComparableTimSort
{
    ...
    private ComparableTimSort(Object aobj[])
    {
        minGallop = 7;
        stackSize = 0;
        a = aobj;
    ...
    private static void binarySort(Object aobj[], int i, int j, int k)
    {
        if (k == i)
        {
            k++;
...
_L2:
        int j1 = l + i1 >>> 1;
        if (comparable.compareTo(aobj[j1]) < 0)
        {
            i1 = j1;
        } else
        {
...
_L5:
    ...
    private static int countRunAndMakeAscending(Object aobj[], int i, int j)
    {
        int l;
        int i1;
        int k = i + 1;
        ...
        l = k + 1;
        if (((Comparable)aobj[k]).compareTo(aobj[i]) >= 0)
        {
            break MISSING_BLOCK_LABEL_115;
        }
        i1 = l;
_L3:
        if (i1 < j && ((Comparable)aobj[i1]).compareTo(aobj[i1 - 1]) < 0) goto _L2; else goto _L1
_L1:
...
_L2:
        i1++;
          goto _L3
        i1 = l;
        while (i1 < j && ((Comparable)aobj[i1]).compareTo(aobj[i1 - 1]) >= 0) 
        {
            i1++;
        }
          goto _L4
    ...
    private static int gallopLeft(Comparable comparable, Object aobj[], int i, int j, int k)
    {
        int l;
        int i1;
        l = 0;
        i1 = 1;
        if (comparable.compareTo(aobj[i + k]) <= 0) goto _L2; else goto _L1
_L1:
        int l2 = j - k;
_L5:
        if (i1 < l2 && comparable.compareTo(aobj[i1 + (i + k)]) > 0) goto _L4; else goto _L3
_L3:
        int l1;
        int i2;
        if (i1 > l2)
...
label0:
        {
            if (i1 < j1 && comparable.compareTo(aobj[(i + k) - i1]) <= 0)
            {
                break label0;
            }
            if (i1 > j1)
        ...
        if (i1 <= 0)
        {
          ...
          goto _L7
        int k2 = j2 + (i2 - j2 >>> 1);
        if (comparable.compareTo(aobj[i + k2]) > 0)
        {
            j2 = k2 + 1;
        } else
        {
    ...
    private static int gallopRight(Comparable comparable, Object aobj[], int i, int j, int k)
    {
        int l;
        int i1;
        l = 1;
...
_L1:
        int k2 = k + 1;
_L5:
        if (l < k2 && comparable.compareTo(aobj[(i + k) - l]) < 0) goto _L4; else goto _L3
_L3:
        int k1;
        int l1;
        if (l > k2)
...
label0:
        {
            if (l < j1 && comparable.compareTo(aobj[l + (i + k)]) >= 0)
            {
                break label0;
            }
            if (l > j1)
        ...
        if (l <= 0)
        {
          ...
          goto _L7
        int j2 = i2 + (l1 - i2 >>> 1);
        if (comparable.compareTo(aobj[i + j2]) < 0)
        {
            l1 = j2;
        } else
        {
    ...
    private void mergeAt(int i)
    {
        ...
        int j1 = gallopRight((Comparable)a[l], a, j, k, 0);
        int k1 = j + j1;
        int l1 = k - j1;
        int i2;
        if (l1 != 0)
        {
            if ((i2 = gallopLeft((Comparable)a[-1 + (k1 + l1)], a, l, i1, i1 - 1)) != 0)
            {
                if (l1 <= i2)
                {
                    mergeLo(k1, l1, l, i2);
...
_L3:
        int k6;
        int l6;
        if (((Comparable)aobj1[j1]).compareTo(aobj[i3]) < 0)
        {
            k6 = l2 - 1;
            l6 = i3 - 1;
            aobj[l2] = aobj[i3];
...
_L2:
        Comparable comparable = (Comparable)aobj1[j1];
        int j4 = j2 - 1;
        k4 = j2 - gallopRight(comparable, aobj, i, j2, j4);
...
label1:
        {
          ...
          goto _L1
        Comparable comparable1 = (Comparable)aobj[i3];
        int j5 = l - 1;
        k5 = l - gallopLeft(comparable1, aobj1, 0, l, j5);
        if (k5 == 0)
        {
...
_L3:
        int j5;
        int k5;
        if (((Comparable)aobj[k2]).compareTo(aobj1[i1]) < 0)
        {
            j5 = j2 + 1;
            k5 = k2 + 1;
            aobj[j2] = aobj[k2];
...
_L2:
        l3 = gallopRight((Comparable)aobj[k2], aobj1, i1, j, 0);
        if (l3 == 0) goto _L5; else goto _L4
_L4:
        System.arraycopy(((Object) (aobj1)), i1, ((Object) (aobj)), j2, l3);
        j2 += l3;
        i1 += l3;
        j -= l3;
...
label1:
        {
          ...
          goto _L1
        for (k4 = gallopLeft((Comparable)aobj1[i1], aobj, j4, l1, 0); k4 == 0; k4 = gallopLeft((Comparable)aobj1[i1], aobj, j4, l1, 0))
        {
            break MISSING_BLOCK_LABEL_602;
        }

        System.arraycopy(((Object) (aobj)), j4, ((Object) (aobj)), i4, k4);
        j2 = i4 + k4;
        k2 = j4 + k4;
        l1 -= k4;
...
_L8:
    ...
    static void sort(Object aobj[])
    {
        sort(aobj, 0, aobj.length);
    }

    static void sort(Object aobj[], int i, int j)
    {
        ...
        if (k < 32)
        {
            binarySort(aobj, i, j, i + countRunAndMakeAscending(aobj, i, j));
            return;
        }
        ComparableTimSort comparabletimsort = new ComparableTimSort(aobj);
        int l = minRunLength(k);
        do
        {
            int i1 = countRunAndMakeAscending(aobj, i, j);
            if (i1 < l)
            {
                int j1;
                if (k <= l)
                ...
                binarySort(aobj, i, i + j1, i + i1);
                i1 = j1;
            }
            comparabletimsort.pushRun(i, i1);
    ...
    public void doSort(Object aobj[], int i, int j)
    {
        stackSize = 0;
        rangeCheck(aobj.length, i, j);
        int k = j - i;
