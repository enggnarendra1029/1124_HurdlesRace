...
//            ParcelableVolumeInfo, IMediaControllerCallback, MediaSessionCompat, PlaybackStateCompat
...
class this._cls0 extends this._cls0
{
    ...
    public ParcelableVolumeInfo getVolumeAttributes()
    {
        ...
        i = this._mth0(this._cls0.this);
        j = this._mth0(this._cls0.this);
...
_L2:
        k = 2;
        l = this._mth0(this._cls0.this).getStreamMaxVolume(j);
        i1 = this._mth0(this._cls0.this).getStreamVolume(j);
          goto _L3
        Exception exception;
        exception;
        obj;
    ...
    {
        return (2 & this._mth0(this._cls0.this)) != 0;
    }
