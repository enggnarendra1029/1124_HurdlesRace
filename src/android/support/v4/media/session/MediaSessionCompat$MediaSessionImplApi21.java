...
//            MediaSessionCompatApi21, PlaybackStateCompat, MediaSessionCompatApi22, MediaSessionCompat
    ...
    implements mSessionObj
{
    ...
    public void setQueue(List list)
    {
        ...
        if (list != null)
        {
            ...
            for (Iterator iterator = list.iterator(); iterator.hasNext(); arraylist.add(((mSessionObj)iterator.next()).())) { }
        }
