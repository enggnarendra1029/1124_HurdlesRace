...
_L9:
        ...
        {
            int j1 = 0;
            while (j1 < mManager.mAdded.size()) 
            {
                Fragment fragment6 = (Fragment)mManager.mAdded.get(j1);
                if (FragmentManagerImpl.DEBUG)
                {
                ...
                if (fragment5 == null || fragment6.mContainerId == fragment5.mContainerId)
                {
                    ...
                    } else
                    {
                        ...
                        mManager.removeFragment(fragment6, k, j);
                    }
                }
                j1++;
            }
...
_L4:
        Fragment fragment4 = op.fragment;
        fragment4.mNextAnim = i1;
        mManager.removeFragment(fragment4, k, j);
          goto _L11
_L5:
        Fragment fragment3 = op.fragment;
        fragment3.mNextAnim = i1;
        mManager.hideFragment(fragment3, k, j);
          goto _L11
_L6:
        Fragment fragment2 = op.fragment;
        fragment2.mNextAnim = l;
        mManager.showFragment(fragment2, k, j);
          goto _L11
_L7:
        Fragment fragment1 = op.fragment;
        fragment1.mNextAnim = i1;
        mManager.detachFragment(fragment1, k, j);
          goto _L11
        Fragment fragment = op.fragment;
        fragment.mNextAnim = l;
        mManager.attachFragment(fragment, k, j);
          goto _L11
        mManager.moveToState(mManager.mCurState, k, j, true);
        if (mAddToBackStack)
        {
