...
class FragmentTransitionCompat21
{
            ...
            Map map1, ArrayList arraylist1)
    {
        if (obj != null || obj1 != null)
        {
            ...
            {
                view.getViewTreeObserver().addOnPreDrawListener(new android.view.ViewTreeObserver.OnPreDrawListener(view, viewretriever, map, map1, transition, arraylist, view1) {
