    ...
    implements mStarterMap
{
    ...
    {
        WeakHashMap weakhashmap = mStarterMap;
        Object obj = null;
        if (weakhashmap != null)
        {
    ...
    private void startAnimation(ViewPropertyAnimatorCompat viewpropertyanimatorcompat, View view)
    {
        ...
        boolean flag = obj instanceof ViewPropertyAnimatorListener;
        ViewPropertyAnimatorListener viewpropertyanimatorlistener = null;
        if (flag)
        {
            viewpropertyanimatorlistener = (ViewPropertyAnimatorListener)obj;
        }
        Runnable runnable = ViewPropertyAnimatorCompat.access$100(viewpropertyanimatorcompat);
        Runnable runnable1 = ViewPropertyAnimatorCompat.access$000(viewpropertyanimatorcompat);
        if (runnable != null)
        {
            runnable.run();
        }
