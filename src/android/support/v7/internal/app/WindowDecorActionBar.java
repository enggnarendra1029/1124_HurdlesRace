    ...
    implements android.support.v7.internal.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
{
    ...
    public WindowDecorActionBar(ActionBarActivity actionbaractivity, boolean flag)
    {
        ...
        View view = actionbaractivity.getWindow().getDecorView();
        init(view);
        if (!flag)
        {
    ...
    private void init(View view)
    {
        ...
        if ((4 & mDecorToolbar.getDisplayOptions()) != 0)
        {
            flag = true;
        } else
        {
        ...
        if (actionbarpolicy.enableHomeButtonByDefault() || flag)
        {
            flag1 = true;
        } else
        {
        ...
        typedarray = mContext.obtainStyledAttributes(null, android.support.v7.appcompat.R.styleable.ActionBar, android.support.v7.appcompat.R.attr.actionBarStyle, 0);
        if (typedarray.getBoolean(android.support.v7.appcompat.R.styleable.ActionBar_hideOnContentScroll, false))
        {
            setHideOnContentScrollEnabled(true);
        }
        j = typedarray.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.ActionBar_elevation, 0);
        if (j != 0)
        {
            setElevation(j);
        }
    ...
    private void setHasEmbeddedTabs(boolean flag)
    {
        ...
        decortoolbar.setCollapsible(flag3);
        actionbaroverlaylayout = mOverlayLayout;
        if (mHasEmbeddedTabs || !flag2)
        {
            flag1 = false;
        }
        actionbaroverlaylayout.setHasNonEmbeddedTabs(flag1);
    }
    ...
    public void animateToMode(boolean flag)
    {
        ...
        decortoolbar.animateToVisibility(byte0);
...
_L6:
    ...
    public void setDisplayOptions(int i, int j)
    {
        ...
        mDecorToolbar.setDisplayOptions(i & j | k & ~j);
    }
...
_L3:
        ...
        decortoolbar.setCollapsible(flag1);
        actionbaroverlaylayout = mOverlayLayout;
        if (i != 2 || mHasEmbeddedTabs)
        {
            flag = false;
        }
        actionbaroverlaylayout.setHasNonEmbeddedTabs(flag);
        return;
_L2:
