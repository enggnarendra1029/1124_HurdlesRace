...
_L6:
    ...
    public ActivityChooserView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mInitialActivityCount = typedarray.getInt(android.support.v7.appcompat.R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = typedarray.getDrawable(android.support.v7.appcompat.R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        typedarray.recycle();
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        measureChild(linearlayoutcompat, i, j);
