    ...
    implements DecorToolbar
{
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean flag, int i, int j)
    {
        ...
        if (flag)
        {
            ...
            CharSequence charsequence = tinttypedarray.getText(android.support.v7.appcompat.R.styleable.ActionBar_title);
            if (!TextUtils.isEmpty(charsequence))
            {
                setTitle(charsequence);
            }
            CharSequence charsequence1 = tinttypedarray.getText(android.support.v7.appcompat.R.styleable.ActionBar_subtitle);
            if (!TextUtils.isEmpty(charsequence1))
            {
                setSubtitle(charsequence1);
            }
            Drawable drawable = tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.ActionBar_logo);
            if (drawable != null)
            {
                setLogo(drawable);
            }
            Drawable drawable1 = tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.ActionBar_icon);
            if (drawable1 != null)
            {
                setIcon(drawable1);
            }
            Drawable drawable2 = tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.ActionBar_homeAsUpIndicator);
            if (drawable2 != null)
            {
            ...
            int l = tinttypedarray.getLayoutDimension(android.support.v7.appcompat.R.styleable.ActionBar_height, 0);
            if (l > 0)
            {
            ...
            int i1 = tinttypedarray.getDimensionPixelOffset(android.support.v7.appcompat.R.styleable.ActionBar_contentInsetStart, -1);
            int j1 = tinttypedarray.getDimensionPixelOffset(android.support.v7.appcompat.R.styleable.ActionBar_contentInsetEnd, -1);
            if (i1 >= 0 || j1 >= 0)
            {
                mToolbar.setContentInsetsRelative(Math.max(i1, 0), Math.max(j1, 0));
            }
            int k1 = tinttypedarray.getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_titleTextStyle, 0);
            if (k1 != 0)
            {
                mToolbar.setTitleTextAppearance(mToolbar.getContext(), k1);
            }
            int l1 = tinttypedarray.getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_subtitleTextStyle, 0);
            if (l1 != 0)
            {
                mToolbar.setSubtitleTextAppearance(mToolbar.getContext(), l1);
            }
            int i2 = tinttypedarray.getResourceId(android.support.v7.appcompat.R.styleable.ActionBar_popupTheme, 0);
            if (i2 != 0)
            {
...
label0:
    ...
    public void setCustomView(View view)
    {
        ...
        mCustomView = view;
        if (view != null && (0x10 & mDisplayOpts) != 0)
        {
