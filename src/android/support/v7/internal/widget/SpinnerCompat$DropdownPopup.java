    ...
    implements dismiss
{
    ...
    void computeContentWidth()
    {
        ...
        if (mDropDownWidth == -2)
        {
            ...
            k1 = getContext().getResources().getDisplayMetrics().widthPixels - SpinnerCompat.access$400(SpinnerCompat.this).left - SpinnerCompat.access$400(SpinnerCompat.this).right;
            if (j1 > k1)
            {
                j1 = k1;
            }
