...
public class SupportMenuInflater extends MenuInflater
{
    ...
    private class MenuState
    {
        ...
        public void readGroup(AttributeSet attributeset)
        {
            ...
            groupId = typedarray.getResourceId(android.support.v7.appcompat.R.styleable.MenuGroup_android_id, 0);
            groupCategory = typedarray.getInt(android.support.v7.appcompat.R.styleable.MenuGroup_android_menuCategory, 0);
            groupOrder = typedarray.getInt(android.support.v7.appcompat.R.styleable.MenuGroup_android_orderInCategory, 0);
            groupCheckable = typedarray.getInt(android.support.v7.appcompat.R.styleable.MenuGroup_android_checkableBehavior, 0);
            groupVisible = typedarray.getBoolean(android.support.v7.appcompat.R.styleable.MenuGroup_android_visible, true);
            groupEnabled = typedarray.getBoolean(android.support.v7.appcompat.R.styleable.MenuGroup_android_enabled, true);
            typedarray.recycle();
        }
        ...
        public void readItem(AttributeSet attributeset)
        {
            ...
            itemId = typedarray.getResourceId(android.support.v7.appcompat.R.styleable.MenuItem_android_id, 0);
            int i = typedarray.getInt(android.support.v7.appcompat.R.styleable.MenuItem_android_menuCategory, groupCategory);
            int j = typedarray.getInt(android.support.v7.appcompat.R.styleable.MenuItem_android_orderInCategory, groupOrder);
            itemCategoryOrder = 0xffff0000 & i | 0xffff & j;
            itemTitle = typedarray.getText(android.support.v7.appcompat.R.styleable.MenuItem_android_title);
            itemTitleCondensed = typedarray.getText(android.support.v7.appcompat.R.styleable.MenuItem_android_titleCondensed);
            itemIconResId = typedarray.getResourceId(android.support.v7.appcompat.R.styleable.MenuItem_android_icon, 0);
            itemAlphabeticShortcut = getShortcut(typedarray.getString(android.support.v7.appcompat.R.styleable.MenuItem_android_alphabeticShortcut));
            itemNumericShortcut = getShortcut(typedarray.getString(android.support.v7.appcompat.R.styleable.MenuItem_android_numericShortcut));
            boolean flag;
            if (typedarray.hasValue(android.support.v7.appcompat.R.styleable.MenuItem_android_checkable))
            {
                int k;
                if (typedarray.getBoolean(android.support.v7.appcompat.R.styleable.MenuItem_android_checkable, false))
                {
                    k = 1;
                } else
                {
            ...
            itemChecked = typedarray.getBoolean(android.support.v7.appcompat.R.styleable.MenuItem_android_checked, false);
            itemVisible = typedarray.getBoolean(android.support.v7.appcompat.R.styleable.MenuItem_android_visible, groupVisible);
            itemEnabled = typedarray.getBoolean(android.support.v7.appcompat.R.styleable.MenuItem_android_enabled, groupEnabled);
            itemShowAsAction = typedarray.getInt(android.support.v7.appcompat.R.styleable.MenuItem_showAsAction, -1);
            itemListenerMethodName = typedarray.getString(android.support.v7.appcompat.R.styleable.MenuItem_android_onClick);
            itemActionViewLayout = typedarray.getResourceId(android.support.v7.appcompat.R.styleable.MenuItem_actionLayout, 0);
            itemActionViewClassName = typedarray.getString(android.support.v7.appcompat.R.styleable.MenuItem_actionViewClass);
            itemActionProviderClassName = typedarray.getString(android.support.v7.appcompat.R.styleable.MenuItem_actionProviderClass);
