...
abstract class BaseMenuWrapper extends BaseWrapper
{
    ...
    final MenuItem getMenuItemWrapper(MenuItem menuitem)
    {
        if (menuitem instanceof SupportMenuItem)
        {
            ...
            if (menuitem1 == null)
            {
                menuitem1 = MenuWrapperFactory.wrapSupportMenuItem(mContext, supportmenuitem);
                mMenuItems.put(supportmenuitem, menuitem1);
            }
            return menuitem1;
        } else
        {
    ...
    final SubMenu getSubMenuWrapper(SubMenu submenu)
    {
        if (submenu instanceof SupportSubMenu)
        {
            ...
            if (submenu1 == null)
            {
                submenu1 = MenuWrapperFactory.wrapSupportSubMenu(mContext, supportsubmenu);
                mSubMenus.put(supportsubmenu, submenu1);
            }
            return submenu1;
        } else
        {
