    ...
    implements MenuView.ItemView
{
    ...
    public ListMenuItemView(Context context, AttributeSet attributeset, int i)
    {
        ...
        mBackground = typedarray.getDrawable(android.support.v7.appcompat.R.styleable.MenuView_android_itemBackground);
        mTextAppearance = typedarray.getResourceId(android.support.v7.appcompat.R.styleable.MenuView_android_itemTextAppearance, -1);
        mPreserveIconSpacing = typedarray.getBoolean(android.support.v7.appcompat.R.styleable.MenuView_preserveIconSpacing, false);
