...
private class resetGroup
{
    ...
    public void readGroup(AttributeSet attributeset)
    {
        ...
        groupId = typedarray.getResourceId(android.support.v7.appcompat.id, 0);
        groupCategory = typedarray.getInt(android.support.v7.appcompat.menuCategory, 0);
        groupOrder = typedarray.getInt(android.support.v7.appcompat.orderInCategory, 0);
        groupCheckable = typedarray.getInt(android.support.v7.appcompat.checkableBehavior, 0);
        groupVisible = typedarray.getBoolean(android.support.v7.appcompat.visible, true);
        groupEnabled = typedarray.getBoolean(android.support.v7.appcompat.enabled, true);
        typedarray.recycle();
    }
    ...
    {
        TypedArray typedarray = SupportMenuInflater.access$100(SupportMenuInflater.this).obtainStyledAttributes(attributeset, android.support.v7.appcompat.ate.this._fld0);
        itemId = typedarray.getResourceId(android.support.v7.appcompat.d, 0);
        int i = typedarray.getInt(android.support.v7.appcompat.enuCategory, groupCategory);
        int j = typedarray.getInt(android.support.v7.appcompat.rderInCategory, groupOrder);
        itemCategoryOrder = 0xffff0000 & i | 0xffff & j;
        itemTitle = typedarray.getText(android.support.v7.appcompat.itle);
        itemTitleCondensed = typedarray.getText(android.support.v7.appcompat.itleCondensed);
        itemIconResId = typedarray.getResourceId(android.support.v7.appcompat.con, 0);
        itemAlphabeticShortcut = getShortcut(typedarray.getString(android.support.v7.appcompat.lphabeticShortcut));
        itemNumericShortcut = getShortcut(typedarray.getString(android.support.v7.appcompat.umericShortcut));
        boolean flag;
        if (typedarray.hasValue(android.support.v7.appcompat.heckable))
        {
            int k;
            if (typedarray.getBoolean(android.support.v7.appcompat.heckable, false))
            {
                k = 1;
            } else
            {
        ...
        itemChecked = typedarray.getBoolean(android.support.v7.appcompat.hecked, false);
        itemVisible = typedarray.getBoolean(android.support.v7.appcompat.isible, groupVisible);
        itemEnabled = typedarray.getBoolean(android.support.v7.appcompat.nabled, groupEnabled);
        itemShowAsAction = typedarray.getInt(android.support.v7.appcompat.ion, -1);
        itemListenerMethodName = typedarray.getString(android.support.v7.appcompat.nClick);
        itemActionViewLayout = typedarray.getResourceId(android.support.v7.appcompat.out, 0);
        itemActionViewClassName = typedarray.getString(android.support.v7.appcompat.wClass);
        itemActionProviderClassName = typedarray.getString(android.support.v7.appcompat.viderClass);
