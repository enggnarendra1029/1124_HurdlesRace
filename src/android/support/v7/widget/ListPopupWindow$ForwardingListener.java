    ...
    implements android.view.dingListener
{
    ...
    private boolean onTouchForwarded(MotionEvent motionevent)
    {
        ...
        mWasLongPress mwaslongpress;
        if (listpopupwindow != null && listpopupwindow.isShowing())
        {
            if ((mwaslongpress = ListPopupWindow.access$600(listpopupwindow)) != null && mwaslongpress.Shown())
            {
                MotionEvent motionevent1 = MotionEvent.obtainNoHistory(motionevent);
                toGlobalMotionEvent(view, motionevent1);
                toLocalMotionEvent(mwaslongpress, motionevent1);
                boolean flag1 = mwaslongpress.ForwardedEvent(motionevent1, mActivePointerId);
