    ...
    implements CollapsibleActionView
{
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView
    {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeset, int i)
        {
            ...
            TintTypedArray tinttypedarray = TintTypedArray.obtainStyledAttributes(context, attributeset, POPUP_WINDOW_ATTRS, i, 0);
    ...
    android.view.View.OnKeyListener mTextKeyListener = new android.view.View.OnKeyListener() {
        ...
        public boolean onKey(View view, int i1, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                {
                    return onSuggestionsKey(view, i1, keyevent);
                }
                if (!mQueryTextView.isEmpty() && KeyEventCompat.hasNoModifiers(keyevent) && keyevent.getAction() == 1 && i1 == 66)
                {
    ...
    private TextWatcher mTextWatcher = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence charsequence1, int i1, int j1, int k1)
        {
        }

        public void onTextChanged(CharSequence charsequence1, int i1, int j1, int k1)
        {
...
_L5:
        ...
        mOnItemSelectedListener = new android.widget.AdapterView.OnItemSelectedListener() {
            ...
            {
                SearchView.this.onItemSelected(i1);
            }
        ...
        TintTypedArray tinttypedarray = TintTypedArray.obtainStyledAttributes(context, attributeset, android.support.v7.appcompat.R.styleable.SearchView, i, 0);
        mTintManager = tinttypedarray.getTintManager();
        ((LayoutInflater)context.getSystemService("layout_inflater")).inflate(tinttypedarray.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_layout, 0), this, true);
        ...
        mSearchPlate.setBackgroundDrawable(tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_queryBackground));
        mSubmitArea.setBackgroundDrawable(tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_submitBackground));
        mSearchIconResId = tinttypedarray.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_searchIcon, 0);
        mSearchButton.setImageResource(mSearchIconResId);
        mSubmitButton.setImageDrawable(tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_goIcon));
        mCloseButton.setImageDrawable(tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_closeIcon));
        mVoiceButton.setImageDrawable(tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_voiceIcon));
        mSearchHintIcon.setImageDrawable(tinttypedarray.getDrawable(android.support.v7.appcompat.R.styleable.SearchView_searchIcon));
        mSuggestionRowLayout = tinttypedarray.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_suggestionRowLayout, 0);
        mSuggestionCommitIconResId = tinttypedarray.getResourceId(android.support.v7.appcompat.R.styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(tinttypedarray.getBoolean(android.support.v7.appcompat.R.styleable.SearchView_iconifiedByDefault, true));
        int j = tinttypedarray.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.SearchView_android_maxWidth, -1);
        if (j != -1)
        {
            setMaxWidth(j);
        }
        CharSequence charsequence = tinttypedarray.getText(android.support.v7.appcompat.R.styleable.SearchView_queryHint);
        if (!TextUtils.isEmpty(charsequence))
        {
            setQueryHint(charsequence);
        }
        int k = tinttypedarray.getInt(android.support.v7.appcompat.R.styleable.SearchView_android_imeOptions, -1);
        if (k != -1)
        {
            setImeOptions(k);
        }
        int l = tinttypedarray.getInt(android.support.v7.appcompat.R.styleable.SearchView_android_inputType, -1);
        if (l != -1)
        {
            setInputType(l);
        }
        setFocusable(tinttypedarray.getBoolean(android.support.v7.appcompat.R.styleable.SearchView_android_focusable, true));
        tinttypedarray.recycle();
...
_L9:
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableinfo)
    {
        ...
        if (j >= 8)
        {
            ...
            int k = searchableinfo.getVoicePromptTextId();
            s2 = null;
            if (k != 0)
            {
                s2 = resources.getString(searchableinfo.getVoicePromptTextId());
            }
            int l = searchableinfo.getVoiceLanguageId();
            s1 = null;
            if (l != 0)
            {
                s1 = resources.getString(searchableinfo.getVoiceLanguageId());
            }
        ...
        intent2.putExtra("android.speech.extra.LANGUAGE", s1);
