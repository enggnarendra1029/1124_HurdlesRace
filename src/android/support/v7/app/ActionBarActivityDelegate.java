...
abstract class ActionBarActivityDelegate
{
        ...
        implements ActionBarDrawerToggle.Delegate, android.support.v4.app.ActionBarDrawerToggle.Delegate
    {
        ...
        {
            Context context = ActionBarActivityDelegate.this.getActionBarThemedContext();
            int ai[] = new int[1];
    ...
    void onCreate(Bundle bundle)
    {
        ...
        if (!typedarray.hasValue(android.support.v7.appcompat.R.styleable.Theme_windowActionBar))
        {
            typedarray.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (typedarray.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionBar, false))
        {
            mHasActionBar = true;
        }
        if (typedarray.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionBarOverlay, false))
        {
            mOverlayActionBar = true;
        }
        if (typedarray.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionModeOverlay, false))
        {
            mOverlayActionMode = true;
        }
        mIsFloating = typedarray.getBoolean(android.support.v7.appcompat.R.styleable.Theme_android_windowIsFloating, false);
        typedarray.recycle();
    }
