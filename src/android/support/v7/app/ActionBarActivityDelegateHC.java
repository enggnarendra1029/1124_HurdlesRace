    ...
    implements android.support.v7.internal.widget.NativeActionModeAwareLayout.OnActionModeForChildListener
{
    ...
    {
        android.support.v7.view.ActionMode actionmode = startSupportActionMode(new android.support.v7.internal.view.SupportActionModeWrapper.CallbackWrapper(view.getContext(), callback));
        if (actionmode != null)
        {
            return new SupportActionModeWrapper(mActivity, actionmode);
        } else
        {
            return null;
        }
