    ...
    implements Runnable
{
    ...
    public void run()
    {
        if ((1 & ActionBarActivityDelegateBase.access$000(ActionBarActivityDelegateBase.this)) != 0)
        {
            ActionBarActivityDelegateBase.access$100(ActionBarActivityDelegateBase.this, 0);
        }
        if ((0x100 & ActionBarActivityDelegateBase.access$000(ActionBarActivityDelegateBase.this)) != 0)
        {
